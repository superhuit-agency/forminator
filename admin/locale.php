...
"Default Value (optional)" => array( null, __("Default Value (optional)", "forminator" ), ), // src/form/components/fields/address.js:112
...
"Placeholder (optional)" => array( null, __("Placeholder (optional)", "forminator" ), ), // src/form/components/fields/address.js:163
...
"{{link}}learn more{{/link}}" => array( null, __("{{link}}learn more{{/link}}", "forminator" ), ), // src/form/components/fields/email/filter-emails.js:55
...
"Use this option to allow or prevent email providers or domains from submitting this form." => array( null, __("Use this option to allow or prevent email providers or domains from submitting this form.", "forminator" ), ), // src/form/components/fields/email/filter-emails.js:87
...
"Learn more about grouping and repeating use cases in {{link}}this tutorial. {{icon/}}{{/link}}" => array( null, __("Learn more about grouping and repeating use cases in {{link}}this tutorial. {{icon/}}{{/link}}", "forminator" ), ), // src/form/components/fields/group/labels.js:23
...
"Choose how images are shown in email notifications. You can embed images directly in the email or display them as clickable links." => array( null, __("Choose how images are shown in email notifications. You can embed images directly in the email or display them as clickable links.", "forminator" ), ), // src/form/components/settings.js:172
"Image Link" => array( null, __("Image Link", "forminator" ), ), // src/form/components/settings.js:185
"This setting applies to images from E-Signature and File Upload fields." => array( null, __("This setting applies to images from E-Signature and File Upload fields.", "forminator" ), ), // src/form/components/settings.js:199
"Image Preview" => array( null, __("Image Preview", "forminator" ), ), // src/form/components/settings.js:207
"This setting applies to images from E-Signature, File Upload, Radio, and Checkbox fields." => array( null, __("This setting applies to images from E-Signature, File Upload, Radio, and Checkbox fields.", "forminator" ), ), // src/form/components/settings.js:221
"Privacy" => array( null, __("Privacy", "forminator" ), ), // src/form/components/settings.js:236
"Choose how you want to handle this form's data storage." => array( null, __("Choose how you want to handle this form's data storage.", "forminator" ), ), // src/form/components/settings.js:239
"By default we will use the configuration you have set in your" => array( null, __("By default we will use the configuration you have set in your", "forminator" ), ), // src/form/components/settings.js:244
"How long do you want to retain this form's submissions for?" => array( null, __("How long do you want to retain this form's submissions for?", "forminator" ), ), // src/form/components/settings.js:259
"Use default" => array( null, __("Use default", "forminator" ), ), // src/form/components/settings.js:269
"Your default setting value is to keep the submissions" => array( null, __("Your default setting value is to keep the submissions", "forminator" ), ), // src/form/components/settings.js:287
...
"Set the value to \"0\" or leave it blank to store submissions forever." => array( null, __("Set the value to \"0\" or leave it blank to store submissions forever.", "forminator" ), ), // src/form/components/settings.js:337
"Account Erasure Requests" => array( null, __("Account Erasure Requests", "forminator" ), ), // src/form/components/settings.js:347
"When handling an account erasure request that contains an email associated with a submission, what do you want to do?" => array( null, __("When handling an account erasure request that contains an email associated with a submission, what do you want to do?", "forminator" ), ), // src/form/components/settings.js:350
"Your default setting value is to " => array( null, __("Your default setting value is to ", "forminator" ), ), // src/form/components/settings.js:380
...
"Submission Files" => array( null, __("Submission Files", "forminator" ), ), // src/form/components/settings.js:415
"If your form has file upload field(s), choose whether to delete the file(s) related to a submission when that submission gets deleted." => array( null, __("If your form has file upload field(s), choose whether to delete the file(s) related to a submission when that submission gets deleted.", "forminator" ), ), // src/form/components/settings.js:418
...
"Add a comma-separated list of additional file types along with their MIME types separated by “ | ”." => array( null, __("Add a comma-separated list of additional file types along with their MIME types separated by “ | ”.", "forminator" ), ), // src/form/components/settings/filetypes.js:116
"{{link}}Learn more{{/link}}" => array( null, __("{{link}}Learn more{{/link}}", "forminator" ), ), // src/form/components/settings/filetypes.js:120
"Allowed filetypes" => array( null, __("Allowed filetypes", "forminator" ), ), // src/form/components/settings/filetypes.js:134
"We use WordPress' {{a}}default allowed mime types{{/a}} to determine which file types can be uploaded. If you want to allow or restrict specific file types from being upload, you can do so by choosing the Specific filetypes option below." => array( null, __("We use WordPress' {{a}}default allowed mime types{{/a}} to determine which file types can be uploaded. If you want to allow or restrict specific file types from being upload, you can do so by choosing the Specific filetypes option below.", "forminator" ), ), // src/form/components/settings/filetypes.js:136
...
"Automatically fill this field using a value passed through your form URL. Enter the query parameter key used in your URL—for example, email in ?email=value. When the form loads, the field will be filled with the matching value." => array( null, __("Automatically fill this field using a value passed through your form URL. Enter the query parameter key used in your URL—for example, email in ?email=value. When the form loads, the field will be filled with the matching value.", "forminator" ), ), // src/form/components/settings/prefill.js:38
...
"Add custom CSS classes to style this field’s container—great for adjusting spacing, colors, or layout." => array( null, __("Add custom CSS classes to style this field’s container—great for adjusting spacing, colors, or layout.", "forminator" ), ), // src/form/components/settings/styling.js:38
"E.g. form-field" => array( null, __("E.g. form-field", "forminator" ), ), // src/form/components/settings/styling.js:60
"Add one or more class names, separated by spaces. These apply to the field container." => array( null, __("Add one or more class names, separated by spaces. These apply to the field container.", "forminator" ), ), // src/form/components/settings/styling.js:68
...
"Auto-saving changes..." => array( null, __("Auto-saving changes...", "forminator" ), ), // src/global/components/meta/status.js:120
"Auto-saving..." => array( null, __("Auto-saving...", "forminator" ), ), // src/global/components/meta/status.js:120
"Saving changes..." => array( null, __("Saving changes...", "forminator" ), ), // src/global/components/meta/status.js:128
"Saving..." => array( null, __("Saving...", "forminator" ), ), // src/global/components/meta/status.js:128
"You’ve made changes that haven’t been saved yet. Click the Save icon to keep them." => array( null, __("You’ve made changes that haven’t been saved yet. Click the Save icon to keep them.", "forminator" ), ), // src/global/components/meta/status.js:134
"Unsaved changes" => array( null, __("Unsaved changes", "forminator" ), ), // src/global/components/meta/status.js:139
"Save changes" => array( null, __("Save changes", "forminator" ), ), // src/global/components/meta/status.js:146
"Autosaved" => array( null, __("Autosaved", "forminator" ), ), // src/global/components/meta/status.js:162
"Saved" => array( null, __("Saved", "forminator" ), ), // src/global/components/meta/status.js:162
"These changes are saved but not yet published." => array( null, __("These changes are saved but not yet published.", "forminator" ), ), // src/global/components/meta/status.js:172
"Click '%s' to make them live." => array( null, __("Click '%s' to make them live.", "forminator" ), ), // src/global/components/meta/status.js:173
"Publish Changes" => array( null, __("Publish Changes", "forminator" ), ), // src/global/components/meta/status.js:175
"Changes autosaved" => array( null, __("Changes autosaved", "forminator" ), ), // src/global/components/meta/status.js:179
"Changes saved" => array( null, __("Changes saved", "forminator" ), ), // src/global/components/meta/status.js:179
"Discard changes" => array( null, __("Discard changes", "forminator" ), ), // src/global/components/meta/status.js:186
"Publish" => array( null, __("Publish", "forminator" ), ), // src/global/components/meta/status.js:225
...
"{{span}}0{{/span}} / {{limit/}} characters" => array( null, __("{{span}}0{{/span}} / {{limit/}} characters", "forminator" ), ), // src/settings/inputs/textarea.js:81
...
"is" => array( null, __("is", "forminator" ), ), // src/utils.js:1166
"is not" => array( null, __("is not", "forminator" ), ), // src/utils.js:1168
"day is" => array( null, __("day is", "forminator" ), ), // src/utils.js:1170
"day is not" => array( null, __("day is not", "forminator" ), ), // src/utils.js:1172
"month is not" => array( null, __("month is not", "forminator" ), ), // src/utils.js:1174
"month is" => array( null, __("month is", "forminator" ), ), // src/utils.js:1176
"is before" => array( null, __("is before", "forminator" ), ), // src/utils.js:1178
"is after" => array( null, __("is after", "forminator" ), ), // src/utils.js:1180
"is before %s or more days from current date" => array( null, __("is before %s or more days from current date", "forminator" ), ), // src/utils.js:1182
"is before less than %s days from current date" => array( null, __("is before less than %s days from current date", "forminator" ), ), // src/utils.js:1184
"is after %s or more days from current date" => array( null, __("is after %s or more days from current date", "forminator" ), ), // src/utils.js:1186
"is after less than %s days from current date" => array( null, __("is after less than %s days from current date", "forminator" ), ), // src/utils.js:1188
"is greater than" => array( null, __("is greater than", "forminator" ), ), // src/utils.js:1190
"is less than" => array( null, __("is less than", "forminator" ), ), // src/utils.js:1192
"contains" => array( null, __("contains", "forminator" ), ), // src/utils.js:1194
"does not contain" => array( null, __("does not contain", "forminator" ), ), // src/utils.js:1196
"starts with" => array( null, __("starts with", "forminator" ), ), // src/utils.js:1198
"ends with" => array( null, __("ends with", "forminator" ), ), // src/utils.js:1200
"is correct" => array( null, __("is correct", "forminator" ), ), // src/utils.js:1202
"is incorrect" => array( null, __("is incorrect", "forminator" ), ), // src/utils.js:1204
"is final result" => array( null, __("is final result", "forminator" ), ), // src/utils.js:1207
"is not final result" => array( null, __("is not final result", "forminator" ), ), // src/utils.js:1209
"Please fix the error(s) in the SETTINGS tab." => array( null, __("Please fix the error(s) in the SETTINGS tab.", "forminator" ), ), // src/utils.js:1513
"Stripe Subscription Add-on is required." => array( null, __("Stripe Subscription Add-on is required.", "forminator" ), ), // src/utils.js:1528
"Billing frequency should be greater than or equal to 1" => array( null, __("Billing frequency should be greater than or equal to 1", "forminator" ), ), // src/utils.js:1563
"Use form settings (Above inputs)" => array( null, __("Use form settings (Above inputs)", "forminator" ), ), // src/utils.js:1660
"Use form settings (Below inputs)" => array( null, __("Use form settings (Below inputs)", "forminator" ), ), // src/utils.js:1660
);
